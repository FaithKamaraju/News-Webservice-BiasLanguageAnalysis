...
import classes from "./AnalysisBar.module.css";

interface AnalysisBarProps {
  content?: string;
}

export default async function AnalysisBar({ content }: AnalysisBarProps) {
...
`;
  ...
  return (
    <Container className={classes.contentContainer}>
      <MarkdownRenderer content={content || defaultAnalysisContent} />
    </Container>
  );
}
